''Module modDecToHexByStrings_June
...
Module modDecToHexByStrings_June
    ...
    ''    Private Function GetPowerOf10_ByAdding(pintPowerOf10 As Integer, pstrErrMessage As String)
    ...
    ''        intMaxLengthOfHex = IIf(intLength1 >= intLength2, intLength1, intLength2)
    ...
    ''    Private Function PadLeft(paramString As String, param_Length As Integer)
