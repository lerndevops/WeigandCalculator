Option Explicit On ''Added 2/1/2019 thomas d.
Option Strict On ''Added 2/1/2019 thomas d.

Public Module modHexToDecByStrings
    ''
    ''Added 2/1/2019 thomas d.
    ''
...
Skip_GoToNextLoop:
    ...
    Private Function GetPowerOf16_InDec_ByArray(pintPowerOf16 As Integer, pstrErrMessage As String) As String
        ...
        If (boolArrayNeedsFirstItem) Then
            ...
            ''2/1/2019 td''ReDim mod_arrayPowersOf16_Dec(static_intLBound To static_intLBound)
            ReDimArrayPowersOf16_Dec(static_intLBound, static_intLBound, False)
        ...
        If (boolAnyError Or ("" = strOut)) Then
            ...
            If (boolArrayNeedsNextItem) Then
                ...
                If (boolMustRedim) Then
                    ''2/1/2019 td''ReDim Preserve mod_arrayPowersOf16_Dec(static_intLBound To pintPowerOf16)
                    ReDimArrayPowersOf16_Dec_Preserve(static_intLBound, pintPowerOf16)
    ...
    Private Function GetPowerOf16_FirstMissing() As Integer
        ...
        For intPowerOf16 = 1 To 100
            ...
            Call GetPowerOf16_InDec_Simple(intPowerOf16, boolMissingHardcoding)
    ...
    Public Function AddAnyTwoDecStrings(pstrDec1 As String, pstrDec2 As String,
        ...
        intMaxLengthOfDec = CInt(IIf(intLength1 >= intLength2, intLength1, intLength2))
    ...
    Private Sub ReDimArrayPowersOf16_Dec_Preserve(par_intLBound As Integer, par_intUBound As Integer)
        ''
        ''Added 1/29/2019 thomas downes  
        ''
        ''This is modelled after:
        ''       modDecToHexByString.vb's Private Sub ReDimArrayPowersOf10_Hex_Preserve
        ''
        ...
        ''2/1/2019 td''ReDimArrayPowersOf10_Hex(par_intLBound, par_intUBound, c_boolPreserveValues)
        ReDimArrayPowersOf16_Dec(par_intLBound, par_intUBound, c_boolPreserveValues)

    End Sub ''eND OF "Private Sub ReDimArrayPowersOf16_Dec_Preserve()"

    Private Sub ReDimArrayPowersOf16_Dec(par_intLBound As Integer, par_intUBound As Integer, par_boolPreserveValues As Boolean)
        ''
        ''Added 2/1/2019 thomas downes  
        ''
        ''This is modelled after:
        ''       modDecToHexByString.vb's Private Sub ReDimArrayPowersOf10_Hex
        ''
        If (par_boolPreserveValues) Then
            ReDim Preserve mod_arrayPowersOf16_Dec(par_intUBound)
        Else
            ReDim mod_arrayPowersOf16_Dec(par_intUBound)
        ...
        For intEach As Integer = 0 To (-1 + par_intLBound)
            ...
            mod_arrayPowersOf16_Dec(intEach) = "@@@@@@@@"

        Next intEach

    End Sub ''eND OF "Private Sub ReDimArrayPowersOf16_Dec()"
